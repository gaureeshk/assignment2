...
\begin{lstlisting}
https://github.com/gaureeshk/assignment2/blob/main/Codes/assignment2.py
\end{lstlisting}
%
and latex-tikz codes from 
%
\begin{lstlisting}
https://github.com/gaureeshk/assignment2/blob/main/assignment2.tex
\end{lstlisting}
\section{Problem}
...
\includegraphics[width=0.5\textwidth]{assignment2.png}
